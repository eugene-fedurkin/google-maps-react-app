...
export default class Map extends Component {
    ...
    setMarker = (event) => {
        ...
        fetch(`https://maps.googleapis.com/maps/api/geocode/json?latlng=${lat},${lng}&result_type=street_address&language=en&key=AIzaSyCXHioGLeLWvHGHdO47hiwu2VlUzb1fZiA`)
            .then(resp => resp.json())
